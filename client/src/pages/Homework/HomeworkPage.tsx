...
import { PuzzlePieceIcon, PlusIcon, ClockIcon, CheckCircleIcon } from '@heroicons/react/24/outline';
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center">
            <div className="p-2 bg-red-100 dark:bg-red-900 rounded-lg">
              <PuzzlePieceIcon className="h-6 w-6 text-red-600 dark:text-red-400" />
            </div>
            <div className="ml-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No homework yet</h3>
